...
/// <summary>
/// PUT body shape for updating a MatchingTask. Deliberately excludes the server-controlled
/// fields that <see cref="MatchingTaskResponse"/> returns (Id, TypeId, Code, CreatedUtc,
...
/// </summary>
public record MatchingTaskUpdateRequest(
    string DisplayName,
    string? Description,
    TaskStateId State,
    string? StateReason,
